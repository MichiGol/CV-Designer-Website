      ...
      >
        {data.summary ? (
          <section style={{ marginBottom: 38 }}>
            <SectionTitle displayFont={displayFont}>About.</SectionTitle>
        ...
        {data.experience.length ? (
          <section style={{ marginBottom: 38 }}>
            <SectionTitle displayFont={displayFont}>Experience.</SectionTitle>
        ...
        {data.education.length ? (
          <section style={{ marginBottom: data.languages.length || data.hobbies.length ? 38 : 0 }}>
            <SectionTitle displayFont={displayFont}>Education.</SectionTitle>
        ...
        {data.languages.length || data.hobbies.length ? (
          <section>
            <SectionTitle displayFont={displayFont}>Extras.</SectionTitle>
            ...
            {data.hobbies.length ? (
              <p style={{ color: "#4b5563", fontFamily: bodyFont, fontSize: 13.5, lineHeight: 1.72, margin: data.languages.length ? "10px 0 0" : 0 }}>
                <strong style={{ color: "#111827" }}>Interests:</strong> {data.hobbies.join(", ")}
              </p>
            ) : null}
          </section>
        ) : null}
