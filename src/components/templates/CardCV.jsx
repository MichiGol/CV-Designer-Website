...
export function CardCV({ cv, st, displayFont, bodyFont, pageMode = "preview" }) {
  ...
  return (
    <div style={{ background: "#f0f4f8", padding: 22, ...(isExportPage ? { minHeight: "100%", boxSizing: "border-box" } : {}) }}>
