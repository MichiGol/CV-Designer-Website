  ...
  return (
    <div
      style={{
        ...
        color: "#37352f",
        fontFamily: displayFont,
        ...(isExportPage ? { boxSizing: "border-box" } : { minHeight: 900 }),
      }}
    >
        ...
        <div style={{ padding: "0 32px" }}>
          ...
          {data.experience.length ? (
            <section style={{ marginBottom: 28 }}>
              <SectionHeading displayFont={displayFont} icon={Briefcase}>{copy.experience}</SectionHeading>
              <div style={{ display: "grid", gap: 18 }}>
                {data.experience.map(item => (
                  <article className="cv-pdf-avoid-break" key={item.id} style={{ cursor: "default" }}>
          ...
          {data.education.length ? (
            <section style={{ marginBottom: 28 }}>
              <SectionHeading displayFont={displayFont} icon={GraduationCap}>{copy.education}</SectionHeading>
          ...
          {data.languages.length || data.hobbies.length ? (
            <section>
              <SectionHeading displayFont={displayFont} icon={Languages}>{copy.details}</SectionHeading>
