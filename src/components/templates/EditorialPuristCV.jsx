...
export function EditorialPuristCV({
  ...
  return (
    <div style={{ background: "#ffffff", ...(isExportPage ? { boxSizing: "border-box" } : {}) }}>
      <div className="editorialpurist-shell" style={{ margin: "0 auto", maxWidth: 880, padding: "56px 58px 68px" }}>
        ...
        {data.summary ? (
          <section style={{ marginBottom: 26 }}>
            <PuristRow bodyFont={bodyFont} left={<SectionTitle displayFont={displayFont}>{copy.profile}</SectionTitle>} withDivider>
        ...
        {data.experience.length ? (
          <section style={{ marginBottom: 28 }}>
            <PuristRow bodyFont={bodyFont} left={<SectionTitle displayFont={displayFont}>{copy.experience}</SectionTitle>} withDivider>
              <div />
            </PuristRow>
        ...
        {data.education.length ? (
          <section style={{ marginBottom: 28 }}>
            <PuristRow bodyFont={bodyFont} left={<SectionTitle displayFont={displayFont}>{copy.education}</SectionTitle>} withDivider>
              <div />
            </PuristRow>
            <div style={{ display: "grid", gap: 28, marginTop: 22 }}>
        ...
        {data.skills.length ? (
          <section>
            <PuristRow bodyFont={bodyFont} left={<SectionTitle displayFont={displayFont}>{copy.skills}</SectionTitle>} withDivider>
        ...
        {extraDetailText ? (
          <section style={{ marginTop: 28 }}>
            <PuristRow bodyFont={bodyFont} left={<SectionTitle displayFont={displayFont}>{copy.details}</SectionTitle>} withDivider>
